...
data_dir=r"../assets/LabPicsV1//" # Path to dataset (LabPics 1)
...
sam2_checkpoint = "../checkpoints/sam2_hiera_large.pt" # path to model weight
model_cfg = "../sam2_configs/sam2_hiera_l.yaml" #  model config
...
for itr in range(1000):
    with torch.cuda.amp.autocast(): # cast to mix precision
            image,mask,input_point, input_label = read_batch(data,batch_size=32) # load data batch
